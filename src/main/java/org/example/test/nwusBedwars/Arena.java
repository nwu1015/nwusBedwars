...
import org.example.test.nwusBedwars.game.Bed;
import org.example.test.nwusBedwars.game.itemSpawner.StartSpawners;
import org.example.test.nwusBedwars.util.Board;
import org.example.test.nwusBedwars.util.Util;
import org.example.test.nwusBedwars.util.WorldCopy;
...
public class Arena {
    ...
    private void startTimeForGame(){
        ...
        }.runTaskTimer(NwusBedwars.getPlugin(NwusBedwars.class), 0L, 20L);
    }
